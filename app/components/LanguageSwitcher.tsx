...
const translations: Record<string, string> = {
  ...
  "Facciata riqualificata": "Renovated facade", "Intonaci, protezione e colore rinnovano il valore dell’intero edificio.": "Render, protection and colour renew the value of the entire building.",
  ...
  "Ristrutturazione bagno effetto marmo": "Marble-effect bathroom renovation", "Rifacimento degli impianti e posa di nuovi rivestimenti scuri per un bagno contemporaneo.": "New systems and dark marble-effect coverings create a contemporary bathroom.",
  ...
  "Guide pratiche, spiegazioni semplici e consigli maturati sul campo, pubblicati su Substack.": "Practical guides, straightforward explanations and advice gained on site, published on Substack.",
