...
const translations: Record<string, string> = {
  ...
  "Dal cantiere": "From the building site", "Conoscere aiuta a costruire meglio.": "Knowledge helps us build better.", "In preparazione": "Coming soon", "Newsletter Substack": "Substack newsletter", "Nuovi consigli direttamente nella tua email.": "New advice delivered to your inbox.",
  ...
  "Da oltre dieci anni lavoriamo nella ristrutturazione, nell'impermeabilizzazione e nella manutenzione strutturale degli edifici toscani. Ogni incarico comincia con l'ascolto e con un sopralluogo svolto direttamente dal titolare.": "For over ten years we have worked on renovations, waterproofing and structural maintenance across Tuscany. Every project begins by listening and with an inspection carried out directly by the owner.",
  "Coordiniamo artigiani e tecnici selezionati nel tempo, scegliendo materiali e lavorazioni adatti all'immobile, al contesto e agli obiettivi del cliente.": "We coordinate carefully selected tradespeople and specialists, choosing materials and methods suited to the property, its setting and the client's goals.",
