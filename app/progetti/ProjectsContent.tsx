...
export function ProjectsContent() {
  return <main>
    ...
    <section className="projects content-section">
      {projects.map(([title, description, before, after, beforeAlt, afterAlt], index) => <article className={`project-case${index <= 3 ? " project-case-landscape" : ""}${index === 0 || index === 3 ? " project-case-contain" : ""}${index === 6 ? " project-case-portrait" : ""}`} key={before}>
